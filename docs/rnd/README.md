...
|---|---|---|---|
| [Canvas Read Warm Path](canvas-read-warm-path.md) | performance / Obsidian format coverage | active | Baseline measures cold and warm `read_canvas` on synthetic 100-node and 1,000-node canvases. |
