...
- Canvas inventory and read outputs now mark listed Canvas paths, read Canvas paths, node identities, node colors, and edge endpoints as untrusted vault content.
